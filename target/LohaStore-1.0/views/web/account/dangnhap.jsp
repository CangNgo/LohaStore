    ...
    <div class="container from-login">
        <div class="row d-flex justify-content-center c-from-login">
            <div class="col-md-4 col-sm-8 wrapper rounded-3">
                <form action="account/dang-nhap" name="login" class="needs-validation" novalidate>
                    ...
                    <div class="box_username box_input mb-4 text-white">
                        ...
                        <input type="text" name="username" id="username"
                            ...
                            required minlength="8" ng-model="username">
                        <span ng-show="login.username.$touched && login.username.$invalid"
                    ...
                    <div class="box_password box_input mb-4 text-white">
                        <div>
                            ...
                            <span ng-show="login.password.$touched && login.password.$invalid"
                                class="text-warning position-absolute">
                    ...
                    <div class="box_remember box_input mb-4 text-white">
                        <div class="box_remember_label box_input_title d-flex justify-content-between">
                            <a href="dang-ky" class="text-decoration-none text-white">Đăng ký</a>
                            <div class="box_remember_right">
                                <a href="doi-mat-khau"
                                    class="forgotPassword box_input_label text-reset text-decoration-none">Quên mật
                                    khẩu</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row  d-flex justify-content-center">
                        <div class="col-md-9">
                            <div class="box_login">
                                <button type="{{login.$valid?'submit':'button'}}" ng-click="checkForm(login.$valid)"
                    ...
                    <div class="box-login-different d-flex justify-content-center mb-4">
                        <img src="<c:url value='/template/web/img/icon _facebook icon_.png' />" alt="" class="me-2">
                        <img src="<c:url value='/template/web/img/google.png' />" alt="">
                    </div>
                </form>
            </div>
        </div>
