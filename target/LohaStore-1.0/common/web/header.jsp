			...
			<div class="row d-flex ">
				...
				<div class="col-md-6">
					<div class="hello-right justify-content-end">
						<i class="fa-solid fa-phone-volume me-1"></i> <a href="#"
							class="m-0 text-decoration-none text-reset">0375663119</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 ps-0 col-logo">
					<div class="logo">
						<img src="/LohaStore/template/web/img/Logo_removebackground.png"
							alt="">
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="row slogan">
						<marquee behavior="" direction="left" scrolldelay="10"
							class="fw-bold">Chuyên sản phẩm len Handmade </marquee>
					</div>
					<div class="row">
						<nav class="navbar navbar-expand-lg ">
							...
							<div
								class="collapse navbar-collapse c-nav-item justify-content-around"
								id="navbarTogglerDemo01">
								<ul class="navbar-nav mr-auto mt-2 mt-sm-0">
									<li class="nav-item active"><a class="nav-link"
										href="trang-chu">Trang chủ <span class="sr-only">(current)</span></a>
									</li>
									<li class="nav-item active"><a class="nav-link"
										href='<c:url value="/hoa-len?category=hoalen" />'>Hoa len <span
											class="sr-only">(current)</span></a></li>
									<li class="nav-item"><a class="nav-link"
										href="moc-khoa?category=mockhoa">Móc khóa</a></li>
				...
				<div
					class="col-md-3 col-sm-6 m-0 p-0 c-nav-right  position-relatives">
					<div class="row user_cart d-flex justify-content-sm-end ">
						<div
							class="col-md-6 col-sm-1 offset-sm-10 cart d-flex justify-content-end m-0">
							<div class="cart-text">
						...
						<div class="col-md-6 col-sm-1 user d-flex justify-content-end m-0">
							<div class="user-text">
								...
								<a href="account/dang-nhap?action=login"
									class="m-0 text-decoration-none">Đăng nhập</a>
								</c:if>
							</div>
							<div class="user-icon">
					...
					<div class="row c_box-search">
						<nav class="navbar navbar-light justify-content-end">
							<form
								class="form-inline my-2 my-sm c-form-search position-relative">
								...
								<i
									class="fa-solid fa-magnifying-glass position-absolute c-icon-search"></i>
							</form>
					</div>
				</div>
			</div>
